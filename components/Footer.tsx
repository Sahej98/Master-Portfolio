    ...
    <footer className='relative bg-white/30 dark:bg-slate-900/40 backdrop-blur-sm border-t border-gray-200/50 dark:border-slate-800/50 pt-20 pb-8 px-4'>
      ...
      <div className='absolute -top-6 left-1/2 -translate-x-1/2'>
        <motion.button
          ...
          className='w-12 h-12 flex items-center justify-center bg-emerald-500 text-white rounded-full shadow-lg hover:bg-emerald-600 transition-colors duration-200'>
